  ...
  if (matchStatus === "BEFORE") {
    return (
      <div className="h-[10%] flex justify-between items-center p-5 rounded-2xl shadow-button">
        <p className=" font-bold text-[18px] md:text-[24px]"> 매칭 전 </p>
        <div className="flex">
          <button
            onClick={handleShowCreateMatchModalBtn}
            className="px-4 py-2 rounded-2xl shadow-button text-white text-[12px] md:text-[15px] font-bold bg-[#9CB7D6]"
          >
            약속 잡기
          </button>
        </div>
    ...
    return (
      <div className="h-[10%] flex justify-between items-center p-5 rounded-2xl shadow-button">
        <p className=" font-bold text-[18px] md:text-[24px]"> 매칭 중 </p>
    ...
    return (
      <div className="h-[10%] flex justify-between items-center p-5 rounded-2xl shadow-button">
        <p className=" font-bold text-[18px] md:text-[24px]"> 여행 완료 </p>
        <div className="flex gap-[10px]">
          <button
